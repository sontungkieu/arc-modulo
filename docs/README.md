...
- `report/`: LaTeX/BibTeX, code dựng artifact, bảng sinh tự động, figure và PDF
  báo cáo đã kiểm tra.
- `slides/`: Beamer source, PDF 22 slide ít chữ, asset và script nói tiếng Việt.
- `das-emd/`: PDF giải thích EMD/Wasserstein-1 của thí nghiệm DAS toy-GMM,
